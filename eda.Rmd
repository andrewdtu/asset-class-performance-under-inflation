...
ggplot(interest_2, aes(x=Date,y=Close,color = as.numeric(EFFR)))+
    ...
    labs(title = "Effective Federal Fund Rates for Each ETF Over Time", x = "Year", y = "Closing Price")
...
ggplot(interest_periods, aes(period_1_return,period_2_return,color = ticker))+
  labs(title = "The Return Rate For Each ETF in Period 1 VS Period 2", x = "Period 1 return rate (%)", y = "Period 2 return rate (%)")+
  geom_point(size = 8)+
  scale_color_tableau() 
